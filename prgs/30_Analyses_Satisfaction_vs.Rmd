...
```{r}
m0 <- brm(lsat ~ treated + (1 + treated | school), data = welle1)
print(m0)

m01 <- lm(lsat ~ treated + factor(school), data = welle1)
summary(m01)

m02 <- lm(lsat ~ treated*school, data = welle1)
summary(m02)
print(m02)
...
tibble(
  " " = c("Intercept", "Treatmetn yes", "School 2", "School 3", "School 4", "School 5", "School 6", "T*School 2", "T*School 3", "T*School 4", "T*School 5", "T*School 6"),
  "Coefficient" = m02$coefficients,
  "Std. Error" = m02$stderr)
...
gr_sat_school_pred_across_schools <- 
  ...
  facet_wrap(vars(school), labeller = labeller(
    school = c("1" = "School: 1", "2" = "School: 2", "3" = "School: 3",
               "4" = "School: 4", "5" = "School: 5", "6" = "School: 6" ))) +
  theme(legend.position="bottom")
ggsave("../figures/sat_school_pred_across_schools.png", gr_lsat_pred_across_schools, 
       width = 7, height = 4, units = "in")
gr_sat_school_pred_across_schools
```
