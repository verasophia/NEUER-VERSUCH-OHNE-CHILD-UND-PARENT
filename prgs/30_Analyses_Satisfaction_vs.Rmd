...
m0.sch1.df <- data.frame(estimate = c(wave2m0.sch1, wave3m0.sch1, wave4m0.sch1, wave5m0.sch1),
...
m0.sch2.df <- data.frame(estimate = c(wave2m0.sch2, wave3m0.sch2, wave4m0.sch2, wave5m0.sch2),
...
m0.sch3.df <- data.frame(estimate = c(wave2m0.sch3, wave3m0.sch3, wave4m0.sch3, wave5m0.sch3),
...
m0.sch4.df <- data.frame(estimate = c(wave2m0.sch4, wave3m0.sch4, wave4m0.sch4, wave5m0.sch4),
...
m0.sch5.df <- data.frame(estimate = c(wave2m0.sch5, wave3m0.sch5, wave4m0.sch5, wave5m0.sch5),
...
m0.sch6.df <- data.frame(estimate = c(wave2m0.sch6, wave3m0.sch6, wave4m0.sch6, wave5m0.sch6),
...
ggarrange(list(sch1, sch2, sch3, sch4, sch5, sch6), ncol = 2, nrow = 3)
...
ggsave("../figures/m0_lsat_across_schools.pdf", m0_lsat_across_schools, 
...
m01.df <- data.frame(complete = c(wave2m01, wave3m01, wave4m01, wave5m01),
