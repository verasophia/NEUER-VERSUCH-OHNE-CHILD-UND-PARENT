...
welle1 <- d %>% filter(welle==1) %>% 
  select(school, pid, welle, treated, lsat, sat_friends, sat_class, sat_school, class.prob, class.excl, note.deu, note.mat, note.mus, hob.mus.making, dauer.mus.lis, dauer.mus.making, play.instr, mus.active, spr.deu, migback, female)
