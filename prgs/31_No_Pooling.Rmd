...
```
```{r}
lm(formula = lsat ~ tXw2 + tXw3 + tXw4 + tXw5 + factor(school) + factor (welle) + hob.mus.making + female + migback
      , data = d
      )
```
...
```{r}
sch1 <- plm(formula = lsat ~  tXw2 + tXw3 + tXw4 + tXw5 + hob.mus.making + female + migback
...
sch1.df <- data.frame(school = c(1, 1, 1, 1),
                         ...
                         lower = c(wave2.sch1 - wave2.sch1.se,
                                   wave3.sch1 - wave3.sch1.se,
                                   wave4.sch1 - wave4.sch1.se,
                                   wave5.sch1 - wave5.sch1.se),
                         upper = c(wave2.sch1 + wave2.sch1.se,
                                   wave3.sch1 + wave3.sch1.se,
                                   wave4.sch1 + wave4.sch1.se,
                                   wave5.sch1 + wave5.sch1.se))
sch1.df
...
```{r}
sch2 <- plm(formula = lsat ~ welle + tXw2 + tXw3 + tXw4 + tXw5 + hob.mus.making + female + migback
...
sch2.df <- data.frame(school = c(2, 2, 2, 2),
                         ...
                         lower = c(wave2.sch2 - wave2.sch2.se,
                                   wave3.sch2 - wave3.sch2.se,
                                   wave4.sch2 - wave4.sch2.se,
                                   wave5.sch2 - wave5.sch2.se),
                         upper = c(wave2.sch2 + wave2.sch2.se,
                                   wave3.sch2 + wave3.sch2.se,
                                   wave4.sch2 + wave4.sch2.se,
                                   wave5.sch2 + wave5.sch2.se))
sch2.df
...
```{r}
sch3 <- plm(formula = lsat ~ welle + tXw2 + tXw3 + tXw4 + tXw5 + hob.mus.making + female + migback
...
sch3.df <- data.frame(school = c(3, 3, 3, 3),
                         ...
                         lower = c(wave2.sch3 - wave2.sch3.se,
                                   wave3.sch3 - wave3.sch3.se,
                                   wave4.sch3 - wave4.sch3.se,
                                   wave5.sch3 - wave5.sch3.se),
                         upper = c(wave2.sch3 + wave2.sch3.se,
                                   wave3.sch3 + wave3.sch3.se,
                                   wave4.sch3 + wave4.sch3.se,
                                   wave5.sch3 + wave5.sch3.se))
sch3.df
...
```{r}
sch4 <- plm(formula = lsat ~ welle + tXw2 + tXw3 + tXw4 + tXw5 + hob.mus.making + female + migback
...
sch4.df <- data.frame(school = c(4, 4, 4, 4),
                         ...
                         lower = c(wave2.sch4 - wave2.sch4.se,
                                   wave3.sch4 - wave3.sch4.se,
                                   wave4.sch4 - wave4.sch4.se,
                                   wave5.sch4 - wave5.sch4.se),
                         upper = c(wave2.sch4 + wave2.sch4.se,
                                   wave3.sch4 + wave3.sch4.se,
                                   wave4.sch4 + wave4.sch4.se,
                                   wave5.sch4 + wave5.sch4.se))
sch4.df
...
```{r}
sch5 <- plm(formula = lsat ~ welle + tXw2 + tXw3 + tXw4 + tXw5 + hob.mus.making + female + migback
...
sch5.df <- data.frame(school = c(5, 5, 5, 5),
                         ...
                         lower = c(wave2.sch5 - wave2.sch5.se,
                                   wave3.sch5 - wave3.sch5.se,
                                   wave4.sch5 - wave4.sch5.se,
                                   wave5.sch5 - wave5.sch5.se),
                         upper = c(wave2.sch5 + wave2.sch5.se,
                                   wave3.sch5 + wave3.sch5.se,
                                   wave4.sch5 + wave4.sch5.se,
                                   wave5.sch5 + wave5.sch5.se))
sch5.df
...
```{r}
sch6 <- plm(formula = lsat ~ welle + tXw2 + tXw3 + tXw4 + tXw5 + hob.mus.making + female + migback
...
sch6.df <- data.frame(school = c(6, 6, 6, 6),
                         ...
                         lower = c(wave2.sch6 - wave2.sch6.se,
                                   wave3.sch6 - wave3.sch6.se,
                                   wave4.sch6 - wave4.sch6.se,
                                   wave5.sch6 - wave5.sch6.se),
                         upper = c(wave2.sch6 + wave2.sch6.se,
                                   wave3.sch6 + wave3.sch6.se,
                                   wave4.sch6 + wave4.sch6.se,
                                   wave5.sch6 + wave5.sch6.se))
sch6.df
...
ggplot(data = all, aes(x = wave, y = estimate)) +
geom_pointrange(aes(ymin = lower, 
