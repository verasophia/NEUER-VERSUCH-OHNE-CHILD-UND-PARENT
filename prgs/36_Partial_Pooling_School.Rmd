...
ggsave("../figures/sat_school_teff.pdf", gr_sat_school_teff, width = 7, height = 4, units = "in")
gr_sat_school_teff
```
...
gr_sat_school_pred_across_schools <- 
  ...
  theme(legend.position="bottom")
ggsave("../figures/sat_school_pred_across_schools.pdf", gr_sat_school_pred_across_schools, 
