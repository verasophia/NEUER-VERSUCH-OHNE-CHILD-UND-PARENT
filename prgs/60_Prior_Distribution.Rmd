...
```{r}
p1 <- readRDS("../resuls/prior_p1.rds")
p2 <- readRDS("../resuls/prior_p2.rds")
p3 <- readRDS("../resuls/prior_p3.rds")
p4 <- readRDS("../resuls/prior_p4.rds")
...
```{r}
lsat_predicted <- grid.arrange(plotp1, plotp2, plotp3, ncol = 3)
ggsave("../figures/lsat_predicted.png", lsat_predicted, width = 5, height = 3, units = "in")
```
