...
After fitting the above models, I extracted the estimates of each of them and plotted them in Figure&nbsp;\@ref(fig:compare-models). (https://jrnold.github.io/bayesian_notes/multilevel-models.html)
...
```{r lsat-teff, echo=FALSE, fig.cap="Predicted life satisfaction for average school", out.width = "80%", fig.align='center'}
...
```{r friends, echo=FALSE, fig.cap="Treatment effects by area of satisfaction for average school",  fig.show = "hold", out.width = "50%", fig.align = "default"}
...
```{r class, echo=FALSE, fig.cap="Treatment effects by area of satisfaction for average school",  fig.show = "hold", out.width = "50%", fig.align = "default"}
