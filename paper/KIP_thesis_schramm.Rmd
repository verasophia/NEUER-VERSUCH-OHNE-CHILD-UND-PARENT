...
knitr::kable(extract_smd, booktabs = T, caption = "Standardized mean differences", col.names = c("treated = 1 vs 0"), digits = 2) %>%
  kable_styling(latex_options = "HOLD_position") %>%
  row_spec(row = c(10,12), background = "#b3cde0")
...
The simplest model is the pooled model, where life satisfaction is modeled as independent and identically distributed draws from a common distribution. The intercept \alpha, the average life satisfaction in this case, is the same for each school.
\begin{align*}
