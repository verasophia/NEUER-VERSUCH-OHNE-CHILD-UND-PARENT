...
\hypertarget{identification-partial-poolin}{%
\subsection{Identification / Partial Poolin\ldots{}}\label{identification-partial-poolin}}
...
Traditional alernatives to multilevel modeling are \emph{complete pooling} in which differences between groups are ignored and \emph{no pooling} in which data grom different sources are analyzed separately
Elreath: \emph{``If we igore the clusters, assigning the same intercept to each of them, then we risk ignoring important variation in baseline survival. This variation could mask association with other variables. If we instead estimate a unique intercept for each cluster, using a dummy variable for each tank, we instead practice anterograde amnesia.'' p416}
...
\centering
\begin{tabu} to \linewidth {>{\raggedleft}X>{\raggedleft}X>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X}
\toprule
school & wave & estimate & lower & upper & Q10 & Q90 & mean\\
\midrule
7 & 1 & NA & NA & NA & -0.3164921 & 0.6909753 & 0.1806651\\
7 & 2 & NA & NA & NA & -0.6898667 & 0.2894317 & -0.2062209\\
7 & 3 & NA & NA & NA & -0.1488093 & 0.8530004 & 0.3448464\\
7 & 4 & NA & NA & NA & -0.9917535 & 0.2854370 & -0.3541457\\
\bottomrule
\end{tabu}
\end{table}
...
\midrule
n & 154 & 163 & \\
lsat (mean (SD)) & 7.50 (2.39) & 7.11 (2.70) & 0.155\\
female (\%) &  &  & 0.159\\
0 & 82 (53.2) & 88 (54.0) & \\
1 & 70 (45.5) & 69 (42.3) & \\
\addlinespace
unknown & 2 ( 1.3) & 6 ( 3.7) & \\
sat\_friends (mean (SD)) & 8.70 (1.82) & 8.99 (1.82) & 0.157\\
sat\_class (mean (SD)) & 7.74 (2.06) & 7.42 (2.00) & 0.156\\
note.deu (mean (SD)) & 2.53 (0.62) & 2.59 (0.61) & 0.097\\
note.mat (mean (SD)) & 2.46 (0.74) & 2.56 (0.73) & 0.128\\
\addlinespace
note.mus (mean (SD)) & 1.91 (0.92) & 1.75 (0.77) & 0.192\\
hob.mus.making = Ja (\%) & 24 (15.6) & 63 (38.7) & 0.537\\
dauer.mus.lis (mean (SD)) & 2.61 (1.02) & 2.51 (1.04) & 0.097\\
dauer.mus.making (\%) &  &  & 0.450\\
gar nicht & 94 (64.8) & 70 (44.0) & \\
\addlinespace
ungefŠhr 30 Min. & 34 (23.4) & 54 (34.0) & \\
1-2 Std. & 13 ( 9.0) & 29 (18.2) & \\
ungefŠhr 3-4 Std. & 3 ( 2.1) & 3 ( 1.9) & \\
ungefŠhr mehr als 4 Std. & 1 ( 0.7) & 3 ( 1.9) & \\
play.instr = Ja (\%) & 41 (30.1) & 53 (34.6) & 0.096\\
\addlinespace
mus.active (mean (SD)) & 0.33 (0.47) & 0.41 (0.49) & 0.165\\
migback (\%) &  &  & 0.151\\
