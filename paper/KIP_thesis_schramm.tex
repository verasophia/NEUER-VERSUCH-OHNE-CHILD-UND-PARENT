...
\includegraphics[width=1\linewidth]{../figures/post_dens_overlay}

\includegraphics[width=1\linewidth]{../figures/post_pred}

\hypertarget{model-validation}{%
\subsection{Model validation}\label{model-validation}}

\hypertarget{graphical-mcmc-diagnostic}{%
\subsubsection{Graphical MCMC diagnostic}\label{graphical-mcmc-diagnostic}}
...
\includegraphics[width=1\linewidth]{../figures/m1_coef}
