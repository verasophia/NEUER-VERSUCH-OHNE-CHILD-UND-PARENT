...
\caption{(\#tab:mean LS)Mean satisfaction}
\centering
\begin{tabular}[t]{lrr}
\toprule
Variable & Mean & SD\\
...
Satisfaction friends & 8.85 & 2.56\\
Satisfaction class & 7.58 & 2.56\\
Satisfaction school & 7.72 & 2.56\\
\bottomrule
\end{tabular}
\end{table}
...
\includegraphics[width=1\linewidth]{../figures/lsat_bar}
\#\#\# Treatment
The treatment is represented by a binary variable, indicating whether a student participated in the treatment (``1'') or not (``0''). The treatment is conducted on the class level. All students in the same class are assigned the same indicator of whether or not they attend the treatment. Students did not change the class.
...
\caption{(\#tab:N Obs per wave and school)Number of observations}
\centering
\begin{tabular}[t]{lrrrrrr}
\toprule
School & Wave 1 & Wave 2 & Wave 3 & Wave 4 & Wave 5 & Sum\\
\midrule
1 & 49 & 43 & 47 & 50 & 53 & 242\\
2 & 54 & 52 & 52 & 49 & 49 & 256\\
3 & 52 & 49 & 51 & 55 & 53 & 260\\
4 & 51 & 47 & 51 & 52 & 51 & 252\\
5 & 63 & 60 & 61 & 46 & 40 & 270\\
\addlinespace
6 & 48 & 43 & 46 & 42 & 41 & 220\\
Sum & 317 & 294 & 308 & 294 & 287 & 1500\\
\bottomrule
\end{tabular}
\end{table}
...
\caption{(\#tab:N Obs)Number of observations}
\centering
\begin{tabular}[t]{lrrrrr}
\toprule
  & Wave 1 & Wave 2 & Wave 3 & Wave 4 & Wave 5\\
\midrule
Treatment group & 163 & 149 & 153 & 143 & 146\\
Control group & 154 & 145 & 155 & 151 & 141\\
\bottomrule
\end{tabular}
\end{table}
...
\caption{(\#tab:std mean diff)Standardized mean differences}
\centering
\begin{tabular}[t]{lr}
\toprule
  & 1 vs 2\\
...
lsat & 0.1547095\\
female & 0.1589880\\
sat\_friends & 0.1567294\\
sat\_class & 0.1557517\\
class.prob & 0.0449783\\
\addlinespace
class.excl & 0.1219881\\
note.deu & 0.0970701\\
note.mat & 0.1283257\\
note.mus & 0.1918611\\
hob.mus.making & 0.5372337\\
\addlinespace
dauer.mus.lis & 0.0966792\\
dauer.mus.making & 0.4497456\\
play.instr & 0.0961298\\
mus.active & 0.1646539\\
migback & 0.1511146\\
\bottomrule
\end{tabular}
\end{table}
...
Using `posterior predict', I generate samples of predictions and compute standard deviations over those samples. This makes explicit the choice between predicting for the participants in the study (i.e.~using the data you used for fitting for predictions) and predicting for hypothetical new participants (the inference for those could - in general - differ)
...
\includegraphics[width=1\linewidth]{../figures/Wie zufrieden bist du....pdf}
